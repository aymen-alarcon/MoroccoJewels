  ...
  <div class="d-flex position-relative" style="z-index:1;">
    <aside class="sidebar d-flex flex-column vh-100 position-fixed ">
      ...
      <nav class="px-3 mt-2 d-flex flex-column gap-2">
        ...
        <a class="nav-link-custom p-2 rounded <?php if(basename($_SERVER["PHP_SELF"]) === "Permissions"){ echo "nav-link-active";} ?>" href="/Admin/Permissions"><i class="bi bi-key"></i><span class="small fw-semibold">Permissions</span></a>
