...
<body>
    ...
    <div class="d-flex flex-column min-vh-100">
        <header class=" mx-auto px-4 px-sm-5 px-lg-6 py-5 d-flex flex-column align-items-center">
            <h1 class="text-center fs-1 fw-normal font-display tracking-wider text-accent mb-4">Trésors Berbères</h1>
