...
<head>
  ...
  <title>Connexion — Bijoux Berbères</title>
...
<body class="position-relative overflow-x-hidden d-flex flex-column">

  <div class="berber-pattern"></div>

  <header class="topbar position-relative z-1">
    <div class="container-xxl py-3 d-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center gap-2 text-white">
        ...
        <h2 class="h5 fw-bold mb-0">Bijoux Berbères</h2>
      </div>

      <nav class="d-none d-md-flex align-items-center gap-4">
        <a href="#" class="text-decoration-none text-white">Collections</a>
        <a href="#" class="text-decoration-none text-white">Héritage</a>
  ...
  <main class="flex-grow-1 d-flex align-items-center justify-content-center py-5 position-relative z-1">
