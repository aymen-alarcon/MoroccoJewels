    ...
    <aside class="sidebar d-flex flex-column justify-content-between p-4">
      <div class="d-flex flex-column gap-4">
        <div class="d-flex align-items-center gap-2">
          ...
          <div>
            <h1 class="h6 fw-bold mb-0" style="color:var(--bb-primary);">Bijoux Berbères</h1>
            <div class="text-uppercase small" style="letter-spacing:.22em;color:rgba(255,255,255,.6)">Portail Admin</div>
          </div>
        </div>

        <nav class="d-flex flex-column gap-2">
          <a href="#" class="text-decoration-none d-flex align-items-center gap-2 muted">
            <span class="material-symbols-outlined" style="color:var(--bb-primary);">dashboard</span><span>Tableau de bord</span>
          </a>
          <a href="#" class="text-decoration-none d-flex align-items-center gap-2 muted">
            <span class="material-symbols-outlined" style="color:var(--bb-primary);">diamond</span><span>Catalogue</span>
          </a>
          <a href="#" class="text-decoration-none d-flex align-items-center gap-2 muted">
            <span class="material-symbols-outlined" style="color:var(--bb-primary);">shopping_cart</span><span>Commandes</span>
          </a>
          <a href="#" class="text-decoration-none d-flex align-items-center gap-2 muted">
            <span class="material-symbols-outlined" style="color:var(--bb-primary);">group</span><span>Clients</span>
          </a>
          <a href="#" class="text-decoration-none d-flex align-items-center gap-2" style="color:var(--bb-primary);font-weight:700;">
            <span class="material-symbols-outlined" style="color:var(--bb-primary);">settings</span><span>Paramètres Profil</span>
          </a>
        </nav>
      </div>

      <button class="btn d-flex align-items-center justify-content-center gap-1 rounded-lg fw-bold" style="height:48px;background:#5a1412;border:1px solid rgba(255,255,255,.1);color:#fff;">
          ...
          <div class="d-flex align-items-center gap-3">
            <div class="position-relative d-none d-lg-block">
              ...
              <input class="form-control ps-5 py-2 rounded-lg"
                     style="background:rgba(90,20,18,.5);border:0;color:#fff;width:260px" placeholder="Rechercher..."/>
            </div>
            <button class="btn btn-sm rounded-circle" style="width:40px;height:40px;background:#5a1412;border:1px solid rgba(255,255,255,.08);color:#fff;">
