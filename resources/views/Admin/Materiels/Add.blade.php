    ...
    <main class="d-flex flex-column overflow-auto w-100" style="margin-left: 15em;">
      <div class="px-4 px-lg-5 py-4 mx-auto w-100">
        <div class="d-flex flex-wrap align-items-end justify-content-between gap-3 mb-4">
          <div>
            <h2 class="display-6 fw-black mb-1">Ajouter un Materiel</h2>
            <p class="mb-0 text-white-50">Définissez le nom du Materiel et ses accès spécifiques au système de gestion de la bijouterie.</p>
          </div>
          <a href="{{ url()->previous() }}" class="btn btn-outline-light rounded-lg d-inline-flex align-items-center gap-1" style="background:rgba(255,255,255,.06);border-color:rgba(255,255,255,.12);">
        ...
        <section class="card-dark rounded p-4 p-lg-5 mb-4">
          ...
          <div class="row g-3">
            <div class="col-12">
              <form action="/Admin/Materiels/AddMateriel/store" method="POST">
                @csrf
                @method("POST")

                <label class="form-label small fw-semibold text-white-75">Nom du Materiel</label>
